...
public class PruebaCancion {
	...
	/**
	 * 
	 * @param miCancion método que recoge la canción seleccionada
	 * @param canciones aquí las canciones son mixeadas en el array
	 */
	...
	/**
	 * 	
	 * @param canciones Muestreo de la canción más larga
	 */
